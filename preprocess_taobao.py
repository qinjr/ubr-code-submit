...
RAW_DIR = '../../ubr4rec-data/taobao/raw_data/'
FEATENG_DIR = '../../ubr4rec-data/taobao/feateng_data/'
    ...
    with open(input_file, 'r') as f:
        ...
        for uid in user_seq_dict:
            if len(user_seq_dict[uid]) > 3:
                ...
                # target_train_lines += [','.join([uid, random_sample()]) + '\n']
                ...
                # target_vali_lines += [','.join([uid, random_sample()]) + '\n']
                ...
                # target_test_lines += [','.join([uid, random_sample()]) + '\n']
...
if __name__ == "__main__":
    ...
    gen_target_seq(FEATENG_DIR + 'remapped_log.csv', FEATENG_DIR + 'user_seq_dict.pkl', FEATENG_DIR + 'target_train.txt', FEATENG_DIR + 'target_vali.txt', FEATENG_DIR + 'target_test.txt', FEATENG_DIR + 'user_seq.txt', FEATENG_DIR + 'database.txt', 
