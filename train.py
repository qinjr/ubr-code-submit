...
def train(data_set_name, target_train_file, user_feat_dict_file,
    ...
    with tf.Session(config=tf.ConfigProto(gpu_options=gpu_options)) as sess:
        ...
        for i in range(10):
            ubr_step = train_ubr_model(ubr_training_monitor, 2, sess, eval_iter_num, taker, ubr_lr, train_batch_size,
...
if __name__ == '__main__':
    ...
    #     context_dict_train_file = DATA_DIR_CCMR + 'context_dict_train.pkl'
    #     context_dict_test_file = DATA_DIR_CCMR + 'context_dict_test.pkl'
