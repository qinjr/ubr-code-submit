...
RAW_DIR = '../../ubr4rec-data/tmall/raw_data/'
FEATENG_DIR = '../../ubr4rec-data/tmall/feateng_data/'
...
if __name__ == "__main__":
    ...
    # gen_target_seq(FEATENG_DIR + 'sorted_remap_joined_user_behavior.csv', FEATENG_DIR + 'target_train.txt', FEATENG_DIR + 'target_vali.txt', FEATENG_DIR + 'target_test.txt', FEATENG_DIR + 'user_seq.txt', FEATENG_DIR + 'database.txt', 
